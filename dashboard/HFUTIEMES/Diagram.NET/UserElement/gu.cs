    ...
    
{
    ...
    public class gu : BaseElement, IControllable, ILabelElement
    {
        [NonSerialized]
        private RectangleController controller;
        protected Image imageDefault = Diagram.NET.Resource.gu;
        protected Image imageAlert = Diagram.NET.Resource.gu1 ;
        protected Image imageWorking = Diagram.NET.Resource.gu2;
        ...
        public virtual Image 正常工作图片
        {
         ...
         public gu(): this(0, 0, 100, 100)
        { }

        public gu(Rectangle rec)
            : this(rec.Location, rec.Size)
        {
            elementMonitoredType = MonitoredType.股;
        }

        public gu(Point l, Size s): this(l.X, l.Y, s.Width, s.Height)
        { }

        public gu(int top, int left, int width, int height)
        {
