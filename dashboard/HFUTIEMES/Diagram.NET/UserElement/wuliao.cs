...
{
    [Serializable]
    public class wuliao : BaseElement, IControllable, ILabelElement
    {
        [NonSerialized]
        ...
        public wuliao(Rectangle rec)
            : this(rec.Location, rec.Size)
        { elementMonitoredType = MonitoredType.岗位物料ANDON; }

        public wuliao(Point l, Size s)
            : this(l.X, l.Y, s.Width, s.Height)
        { }

        public wuliao(int top, int left, int width, int height)
        {
