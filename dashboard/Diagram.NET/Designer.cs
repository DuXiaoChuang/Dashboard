...
namespace Dalssoft.DiagramNet
{
	public class Designer : System.Windows.Forms.UserControl
	{
        ...
        private TypeOfDesigner type = TypeOfDesigner.≈‰÷√;
        private IsShowGrid showGrid = IsShowGrid.∑Ò;
		// Resize
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "Designer";
            this.Size = new System.Drawing.Size(1920, 865);
		...
		protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		{
            ...
            if (this.Type == TypeOfDesigner.º‡øÿ)
            {
                if (begin)
                {
                    document.DrawElementsAlert(g, clipRectangle);
                }
                else
                {
                    document.DrawElements(g, clipRectangle);
		...
		protected override void OnKeyDown(KeyEventArgs e)
		{
            ...
            if (e.KeyCode == Keys.A || e.KeyCode == Keys.Left)//◊Û
            {
                document.SelectedElementMoveLeft();
            }
            if (e.KeyCode == Keys.W || e.KeyCode == Keys.Up)//…œ
            {
                document.SelectedElementMoveUp();
            }
            if (e.KeyCode == Keys.D || e.KeyCode == Keys.Right)//”“
            {
                document.SelectedElementMoveRight();
            }
            if (e.KeyCode == Keys.S|| e.KeyCode == Keys.Down)//œ¬
            {
                document.SelectedElementMoveDown();
            }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
                    ...
                    case DesignerAction.Select:
                        if (e.Button == MouseButtons.Left)
                        {
                            ...
                            if (selectedElement != null)
                            {
                                ...
                                {
                                    if (selectedElement.º‡øÿ¿‡–Õ != MonitoredType.øÿ÷∆µÿ÷∑)
                                    {
            ...
            #region º‡øÿ
            else if (this.Type == TypeOfDesigner.º‡øÿ)
            {
                Point mousePoint;
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else
            {
                if (e.Button == MouseButtons.None)
                {
                    ...
                    if (mousePointerElement != mousePointerElementTMP)
                    {
                        if (mousePointerElementTMP.º‡øÿ¿‡–Õ != MonitoredType.«¯”Ú)
                        {
		...
		private void document_ElementPropertyChanged(object sender, EventArgs e)
		{
			...
			{
				AddUndo();
                //ClassLib.GetAllIPAddress(document);
				base.Invalidate();
			}
		}
        ...
        public void UpObject()//µ•ª˜∫Û…Ë÷√ Û±Í—˘ Ω
        {
            if ((moveAction != null) && (moveAction.IsMoving))
            {
                this.Cursor = Cursors.SizeAll;
		...
		private void EndAddElement(Rectangle selectionRectangle)
		{
			...
			switch (document.ElementType)
			{
                ...
                case ElementType.Zone:
                    el = new ZoneElement(selectionRectangle);
                    break;
                case ElementType.Andon:
                    el = new AndonElement(selectionRectangle);
                    break;

                case ElementType.StartEndPoint:
                    el = new StartEndElement(selectionRectangle);
                    break;
                
                case ElementType.zoneAlarmElement:
                    el = new ZoneAlarmElement(selectionRectangle);
                    break;
                case ElementType.Workcenter:
                    el = new WorkCenter(selectionRectangle);
                    break;
                case ElementType.LEDAndon:
                    el = new LEDAndon(selectionRectangle);
                    break;
				default:
					el = new RectangleNode(selectionRectangle);
					break;
                //case ElementType.FSM:
                //    el = new FSM(selectionRectangle);
                //    break;
                case ElementType.TextWeek:
                    el = new TextWeek(selectionRectangle);
                    break;
                case ElementType.TextTime:
                    el = new TextTime(selectionRectangle);
                    break;
                case ElementType.TextDate:
                    el = new TextDate(selectionRectangle);
                    break;
                case ElementType.WorkOrder:
                    el = new WorkOrder(selectionRectangle);
                    break;
                case ElementType.NetConnectState:
                    el = new NetConnectState(selectionRectangle);
                    break;
                case ElementType.WorkOrderTile:
                    el = new WorkOrderTile(selectionRectangle);
                    break;
                case ElementType.StraightLine:
                    el = new StraightLine(selectionRectangle);
                    break;
                case ElementType.zhiliang :
                    el = new zhiliang(selectionRectangle);
                    break;
                //case ElementType. ±º‰:
                //    el = new  ±º‰(selectionRectangle);
                    //break;
                case ElementType.gu:
                    el = new gu(selectionRectangle);
                    break;
                case ElementType.EquipmentElement :
                    el = new EquipmentElement(selectionRectangle);
                    break;
                case ElementType.xiaoxi :
                    el = new xiaoxi(selectionRectangle);
                    break;
                case ElementType.wuliao :
                    el = new wuliao(selectionRectangle);
                    break;
                case ElementType.Personnel :
                    el = new PersonnelElement(selectionRectangle);
                    break;
                case ElementType.Rack :
                    el = new RackElement(selectionRectangle);
                    break;
                case ElementType.WorkCenterModel:
                    el = new WorkCenterModel(selectionRectangle);
                    break;
                case ElementType.Rfid :
                    el = new RfidElement(selectionRectangle);
                    break;
                case ElementType.EquipState:
                    el = new EquipState(selectionRectangle);
                    break;
                case ElementType.EquipAlarmExcel:
                    el = new EquipAlarmExcel(selectionRectangle);
                    break;
                case ElementType.ToolStateExcel:
                    el = new ToolStateExcel(selectionRectangle);
                    break;
                case ElementType.OnlineNumber:
                    el = new OnlineNumber(selectionRectangle);
                    break;
                case ElementType.ProductTraceExcel:
                    el = new ProductTraceExcel(selectionRectangle);
                    break;
                case ElementType.ToolState:
                    el = new ToolState(selectionRectangle);
                    break;
                case ElementType.Temperature:
                    el = new Temperature(selectionRectangle);
                    break;
                case ElementType.shidu:
                    el = new shidu(selectionRectangle);
                    break;
                case ElementType.dianneng:
                    el = new dianneng(selectionRectangle);
                    break;
            }
