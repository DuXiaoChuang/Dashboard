...
{
    [Serializable]
    public class IPCElement : BaseElement, IControllable, ILabelElement
    {
        [NonSerialized]
        private RectangleController controller;
        protected Image imageDefault = Diagram.NET.Resource.IPCOn;
        protected Image imageWorking = Diagram.NET.Resource.IPCOn;
        protected Image imageAlert = Diagram.NET.Resource.IPCOn;
        protected Image imageNetBreak = Diagram.NET.Resource.IPCOn;
        ...
        public IPCElement(): this(0, 0, 100, 100)
        { }

        public IPCElement(Rectangle rec): this(rec.Location, rec.Size)
        { elementMonitoredType = MonitoredType.工控机; }

        public IPCElement(Point l, Size s): this(l.X, l.Y, s.Width, s.Height)
        { }

        public IPCElement(int top, int left, int width, int height)
        {
