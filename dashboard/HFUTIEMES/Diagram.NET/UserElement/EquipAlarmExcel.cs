...
namespace Dalssoft.DiagramNet
{
    ...
    public class EquipAlarmExcel : BaseElement, IControllable
    {
        ...
        internal override void Draw(Graphics g)
        {
            ...
            DataTable dt = DbHelperSQL.OpenTable(sql);
            //var dt = DbHelperSQL.OpenTable("select EquipCode,EquipName,AddressContent,StateStarttime from Equip_State_P where StateDescription='设备报警' order by StateStarttime ");
            if (dt.Rows.Count > 0)
            {
                arr = null;
