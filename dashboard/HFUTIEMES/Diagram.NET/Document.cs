...
namespace Dalssoft.DiagramNet
{
	...
	public class Document: IDeserializationCallback 
	{
        ...
        private string id;
        private string code;
        private CanvasType canvasType = CanvasType.无;
        private ProductionLineType proLineType = ProductionLineType.无;
        private bool canBeMonitored = false;
        private string alertMedia = "alert.wav";
        private bool showAlertMedia = false;
        ...
        public void ElementMoveLeft(BaseElement el)
        {
            el.Location = new Point(el.Location.X - 1, el.Location.Y);
            OnAppearancePropertyChanged(new EventArgs());
        }

        public void SelectedElementMoveLeft()
        {
            selectedElements.EnabledCalc = false;
            selectedNodes.EnabledCalc = false;
            ...
            for (int i = selectedElements.Count - 1; i >= 0; i--)
            {
                ElementMoveLeft(selectedElements[i]);
            }
        ...
        public void ElementMoveRight(BaseElement el)
        {
            el.Location = new Point(el.Location.X + 1, el.Location.Y);
            OnAppearancePropertyChanged(new EventArgs());
        }

        public void SelectedElementMoveRight()
        {
            selectedElements.EnabledCalc = false;
            selectedNodes.EnabledCalc = false;
            ...
            for (int i = selectedElements.Count - 1; i >= 0; i--)
            {
                ElementMoveRight(selectedElements[i]);
            }
        ...
        public void ElementMoveUp(BaseElement el)
        {
            el.Location = new Point(el.Location.X, el.Location.Y - 1);
            OnAppearancePropertyChanged(new EventArgs());
        }

        public void SelectedElementMoveUp()
        {
            selectedElements.EnabledCalc = false;
            selectedNodes.EnabledCalc = false;
            ...
            for (int i = selectedElements.Count - 1; i >= 0; i--)
            {
                ElementMoveUp(selectedElements[i]);
            }
        ...
        public void ElementMoveDown(BaseElement el)
        {
            el.Location = new Point(el.Location.X, el.Location.Y + 1);
            OnAppearancePropertyChanged(new EventArgs());
        }

        public void SelectedElementMoveDown()
        {
            selectedElements.EnabledCalc = false;
            selectedNodes.EnabledCalc = false;
            ...
            for (int i = selectedElements.Count - 1; i >= 0; i--)
            {
                ElementMoveDown(selectedElements[i]);
            }
        ...
        public bool CanBeMonitored
        {
            ...
            set
            {
                canBeMonitored = value;
            }
        }

        public ProductionLineType 监控区域
        {
            get
            {
                return proLineType;
        ...
        [Category("基本信息")]
        [DynamicProps.DynamicReadonly("是否有报警音乐")]
        [DefaultValue(false)]
        [RefreshProperties(RefreshProperties.All)]
        public string 报警音乐
        {
        ...
        [Category("基本信息")]
        [DynamicProps.DynamicReadonly("CanBeMonitored")]
        [DefaultValue(false)]
        [RefreshProperties(RefreshProperties.All)]
        public bool 是否有报警音乐
        {
            get
            {
                return showAlertMedia;
            }
            set
            {
                showAlertMedia = value;
            }
        }

        [ReadOnly(true)]
        [Category("基本信息")]
        public CanvasType 画布类型
        {
            get
            {
                return canvasType;
        ...
        internal void DrawElementsAlert(Graphics g, Rectangle clippingRegion)
        {
            CalcWindow(true);
            for (int i = 0; i <= elements.Count - 1; i++)
            {
                ...
                if (NeedDrawElement(el, clippingRegion))//判断是否监控
                {
                    if (el is NodeElement)
                    {
                        NodeElement n = (NodeElement)el;
