...
namespace Dalssoft.DiagramNet
{
    ...
    public class Groove : BaseElement, IControllable, ILabelElement
    {
        ...
        internal override void Draw(Graphics g)
        {
            ...
            string sql="select toolcode from Tool_State_P where EquipId= '"+monitoredObjectID+"'and AddressContent = '"+groove+"'";
            DataTable dt = DbHelperSQL.OpenTable(sql);
            if (dt.Rows.Count > 0) { toolcode = dt.Rows[0][0].ToString(); }
