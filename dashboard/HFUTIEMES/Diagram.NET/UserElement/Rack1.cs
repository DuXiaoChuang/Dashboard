...
namespace Dalssoft.DiagramNet
{
    ...
    public class Rack1 : BaseElement, IControllable, ILabelElement
    {
        [NonSerialized]
        private RectangleController controller;
        private volatile bool IsTwinkle = false;
        protected Image imageDefault = Diagram.NET.Resource.料架2;
        protected Image imageWorking = Diagram.NET.Resource.料架2;
        protected Image imageAlert = Diagram.NET.Resource.料架2;
        ...
        public Rack1(): this(0, 0, 100, 100)
        { }

        public Rack1(Rectangle rec) : this(rec.Location, rec.Size)
        { elementMonitoredType = MonitoredType.料架1; }

        public Rack1(Point l, Size s) : this(l.X, l.Y, s.Width, s.Height)
        { }

        public Rack1(int top, int left, int width, int height)
        {
