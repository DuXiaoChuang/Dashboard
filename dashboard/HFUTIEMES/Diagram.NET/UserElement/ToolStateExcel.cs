...
namespace Dalssoft.DiagramNet
{
    ...
    public class ToolStateExcel : BaseElement, IControllable
    {
        ...
        internal override void Draw(Graphics g)
        {
            ...
            //g.DrawLine(new Pen(borderColor, borderWidth), location.X + line1 + 6 * a, location.Y, location.X + line1 + 6 * a, location.Y + (int)(size.Height));
            var dt = DbHelperSQL.OpenTable("select ToolCode,ToolResidualLife,lifeWarning,EquipCode,UseTime from Tool_State_P order by EquipCode ");
            if (dt.Rows.Count > 0)
            {
                arr = null;
           ...
           { g.DrawImage(imageDefault, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c))); }
            ...
            if (rr =="T010")
            {
            Image imageDefault1 = Diagram.NET.Resource.T010;
            ...
            if (rr == "aa")
            {
             Image imageDefault1 = Diagram.NET.Resource.aa;
             g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
             }
             if (rr == "bb")
             {
              Image imageDefault1 = Diagram.NET.Resource.bb;
              g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
               }
              if (rr == "cc")
            {
                Image imageDefault1 = Diagram.NET.Resource.cc;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "dd")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.dd;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "ee")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.ee;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "ff")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.ff;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "D0000001")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.D0000001;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "D0000002")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.D0000002;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T002")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T002;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T003")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T003;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T005")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T005;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T006")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T006;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T007")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T007;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T010")
                            {
                            ...
                            if (rr == "T011")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T011;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T012")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T012;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                            if (rr == "T013")
                            {
                                Image imageDefault1 = Diagram.NET.Resource.T013;
                                g.DrawImage(imageDefault1, new RectangleF(new System.Drawing.Point(location.X, location.Y + (int)(size.Height * (1.5 + x) / (1.5 + rows))), new Size(line1, c)));
                            }
                        }
